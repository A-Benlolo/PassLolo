...
public final class TextRenderer {
	 ...
	 * location and automatic wrapping of text. The <i>align</i> property determines
	 ...
	 * @param color  The <code>Color</code> to use when drawing the text
	 * @param bounds A <code>Rectangle</code> representing the bounds of the text
	 * @param align  A <code>TextAlignment</code> value representing the location to
	 *               draw the text, relative to the <i>bounds</i>
	 * @return A <code>Rectangle</code> representing the bounds consumed by the text
	 */
	public static Rectangle drawString(Graphics g, String text, Font font, Color color, Rectangle bounds,
			TextAlignment align) {
	 ...
	 * @return A <code>Rectangle</code> representing the bounds consumed by the text
	 */
	public static Rectangle getRectangeFor(String text, Font font, Color color, Rectangle bounds, TextAlignment align,
			int format) {
		if (text == null)
			throw new NullPointerException("The text cannot be null.");
		if (font == null)
	 ...
	 *                         <code>LineBreakMeasurer</code> <i>nextOffset</i>
	 *                         method
